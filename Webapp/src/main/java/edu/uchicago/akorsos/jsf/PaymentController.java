...
import edu.uchicago.akorsos.beans.PaymentFacade;
...
public class PaymentController implements Serializable {
    ...
    @EJB
    private edu.uchicago.akorsos.beans.PaymentFacade ejbFacade;
    ...
    public String prepareView() {
        current = (Payment) getItems().getRowData();
    ...
    public String create() {
        try {
            ...
            current.setTeamId(34);
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/Bundle").getString("PaymentCreated"));
    ...
    public String update() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/Bundle").getString("PaymentUpdated"));
            return "View";
        } catch (Exception e) {
            JsfUtil.addErrorMessage(e, ResourceBundle.getBundle("/Bundle").getString("PersistenceErrorOccured"));
            return null;
    ...
    private void performDestroy() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/Bundle").getString("PaymentDeleted"));
        } catch (Exception e) {
            JsfUtil.addErrorMessage(e, ResourceBundle.getBundle("/Bundle").getString("PersistenceErrorOccured"));
        }
    }
    ...
    public Payment getPayment(java.lang.Integer id) {
