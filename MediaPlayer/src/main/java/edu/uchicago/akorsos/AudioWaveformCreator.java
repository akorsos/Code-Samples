...
public class AudioWaveformCreator {
    ...
    public void createAudioInputStream() throws Exception {
        if (file != null && file.isFile()) {
            try {
                System.out.println("Trying to make image");
                errStr = null;
...
//           
//        AudioWaveformCreator awc = new AudioWaveformCreator("C:/Java/NetBeansProjects/proFinalAdv/target/classes/testMusic/kindercut.mp3", "C:/Java/NetBeansProjects/proFinalAdv/target/classes/testMusic");
