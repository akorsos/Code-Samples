...
public class CommandCenter {
    ...
    private static Odin odinSat;
    private static int nOdin;
    private static int nForcePush;
    private static int nSlow;
    ...
    public static void setOdinSat(int nParam){
        nOdin = nParam;
    }

    public static int getOdinSat(){
		return nOdin;
	}

    public static void setForcePush(int nParam){
        nForcePush = nParam;
    }

    public static int getForcePush(){
		return nForcePush;
	}

    public static void setOdinSat(Odin odinParam){
        odinSat = odinParam;
    }

    public static void setSlow(int nParam){
        nSlow = nParam;
    }
